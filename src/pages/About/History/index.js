  ...
  return (
    <section id="History" className="bg-light py-5">
      ...
      <Container className="py-5">
        ...
        <h4 className="fw-bold">Restructuring</h4>
        <p className="lead">
          ...
          services. We are grateful for the impact she has made as the Founder
          of Tabernacle School and we continue to honor her vision and her love
          for children. A management team was formed to oversee the day-to-day
          operations of the school, while our school board continues to be
          responsible for the vision, mission and finances of the school.
        </p>
        <h4 className="fw-bold">Present Day</h4>
        <p className="lead">
